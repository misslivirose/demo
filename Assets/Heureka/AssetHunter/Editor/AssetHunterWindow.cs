...
public class AssetHunterWindow : EditorWindow, ISerializationCallbackReceiver
{
    ...
    private static AssetHunterWindow doInit()
    {
        ...
        EditorUtils.SetWindowValues(m_window, Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterLogoSmall.png", typeof(Texture)) as Texture, "Asset Hunter");
        m_window.m_UIWarning = Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterWarning.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIWideLogo = Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterLogoWide.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIAchievementIcon = Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterAchievementUnlocked.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UISceneSelect = Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterSceneSelect.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIFolderSelect = Resources.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterFolderSelect.png", typeof(Texture2D)) as Texture2D;
